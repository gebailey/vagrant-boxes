...
# General settings
vboxmanage modifyvm mate --description "Fedora 38 with MATE Desktop"
...
vboxmanage controlvm mate keyboardputstring " selinux=0 inst.selinux=0 inst.text inst.ks=https://lxpro.com/fedora38-mate.ks"
# Ctrl-X
...
vboxmanage export mate -o fedora38-mate-$(date +%Y%m%d).ova --vsys 0 --product fedora38-mate --version $(date +%Y%m%d) --description "Fedora 38 with MATE Desktop"
