...
wget -nv https://go.dev/dl/go1.22.4.linux-amd64.tar.gz
tar -C /usr/local -xzf go1.22.4.linux-amd64.tar.gz
rm -f go1.22.4.linux-amd64.tar.gz
echo 'export PATH=$PATH:/usr/local/go/bin' > /etc/profile.d/golang.sh

wget -nv https://github.com/restic/restic/releases/download/v0.16.4/restic_0.16.4_linux_amd64.bz2
...
wget -nv https://download.docker.com/linux/fedora/40/x86_64/stable/Packages/docker-buildx-plugin-0.14.1-1.fc40.x86_64.rpm
dnf -y install ./docker-buildx-plugin-0.14.1-1.fc40.x86_64.rpm
rm -f docker-buildx-plugin-0.14.1-1.fc40.x86_64.rpm

wget -nv https://download.docker.com/linux/fedora/40/x86_64/stable/Packages/docker-compose-plugin-2.27.1-1.fc40.x86_64.rpm
dnf -y install ./docker-compose-plugin-2.27.1-1.fc40.x86_64.rpm
rm -f docker-compose-plugin-2.27.1-1.fc40.x86_64.rpm
